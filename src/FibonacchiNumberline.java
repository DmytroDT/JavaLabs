...
/**
 * 
 * @author dmytro A class that holds numerous variables with properties of
 *         numerical series. Main way to work with it is through it's methods.
 */
...
public class FibonacchiNumberline {
	...
	/**
	 * 
	 * @param lowerBoarder - lower border of numerical series
	 * @param upperBoarder - upper border of numerical series
	 * @param Fibonborder  - amout of fibonacchi numbers that will be created
	 */
